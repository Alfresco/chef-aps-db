...
issues_url 'https://github.com/Alfresco/chef-aps-db/issues' if respond_to?(:issues_url)

# If you upload to Supermarket you should set this so your cookbook
# gets a `View Source` link
source_url 'https://github.com/Alfresco/chef-aps-db' if respond_to?(:source_url)
